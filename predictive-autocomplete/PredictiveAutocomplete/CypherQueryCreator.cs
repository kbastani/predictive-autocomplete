...
namespace PredictiveAutocomplete
{
    ...
    public class CypherQueryCreator
    {
        ...
        {
            var newBuilder = Clone();
            newBuilder.returnText = CypherReturnExpressionBuilder.BuildText(expression).Text;
            newBuilder.returnDistinct = distinct;
        ...
        IAttachedReference
    {
        ...
        private static HttpClientWrapper GetNeo4jAuthenticatedClient(HttpClient httpClient, Uri databaseUri)
        {
            ...
            if (httpClient == null)
            {
                ...
                httpClient.DefaultRequestHeaders.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Authorization", Convert.ToBase64String(Encoding.ASCII.GetBytes(Configuration.GetAuthorizationHeader())));
            }
            ...
            PredictiveAutocomplete.HttpClientWrapper clientWrapper = new PredictiveAutocomplete.HttpClientWrapper(httpClient);
        ...
        public CypherFluentQueryCreator(IGraphClient client, CypherQueryCreator builder, Uri databaseUri)
        {
            ...
            httpClient = new PredictiveAutocomplete.HttpClientWrapper();
    ...
    public class HttpClientWrapper : IHttpClient
    {
        ...
        {
            if (request.RequestUri.ToString().Contains(Configuration.GetDatabaseUri()))
            {
                client.DefaultRequestHeaders.Authorization = new System.Net.Http.Headers.AuthenticationHeaderValue("Authorization", Convert.ToBase64String(Encoding.ASCII.GetBytes(Configuration.GetAuthorizationHeader())));
            }
            else
            {
